...
typedef actionlib::SimpleActionServer<test_ur5_common_bringup::GripAction> Server;
typedef boost::function<void(test_ur5_common_bringup::GripGoalConstPtr&)> ExecuteCallback;

void executeSim(const test_ur5_common_bringup::GripGoalConstPtr& goal, Server* as, ros::Publisher* gripper_command_pub)
{
    ...
    test_ur5_common_bringup::GripResult result;
...
void executeReal(const test_ur5_common_bringup::GripGoalConstPtr& goal, Server* as, ros::Publisher* gripper_command_pub)
{
    // TODO: Check and see if n needs to be redefined here
...
int main(int argc, char** argv)
{
    ...
    ros::NodeHandle pnh("~");
    ros::NodeHandle n;
    void (*executeFunc)(const test_ur5_common_bringup::GripGoalConstPtr& goal, Server* as, ros::Publisher* gripper_command_pub);
